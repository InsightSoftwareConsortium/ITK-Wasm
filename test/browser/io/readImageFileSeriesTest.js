...
function verifyImage (t, image) {
  ...
  t.is(getMatrixElement(image.direction, 0, 2), 0.0, 'direction (0, 2)')
  ...
  t.is(getMatrixElement(image.direction, 2, 1), 0.0, 'direction (2, 1)')
  t.is(getMatrixElement(image.direction, 2, 2), 1.0, 'direction (2, 2)')

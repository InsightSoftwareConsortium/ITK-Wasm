...
const testInputFilePath = path.resolve('build', 'ExternalData', 'test', 'Input', 'ironProt.vtk')
const testOutputFilePath = path.resolve('build', 'Testing', 'Temporary', 'VTKTest-ironProt.vtk')

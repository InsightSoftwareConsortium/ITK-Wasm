...
const testInputFilePath = path.resolve('build-emscripten', 'ExternalData', 'test', 'Input', 'cow.vtk')
const testOutputFilePath = path.resolve('build-emscripten', 'Testing', 'Temporary', 'writeMeshLocalFileTest-cow.vtk')

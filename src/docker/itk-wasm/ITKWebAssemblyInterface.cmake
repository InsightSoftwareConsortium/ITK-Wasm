...
function(add_executable target)
  ...
  if(EMSCRIPTEN)
    ...
    get_property(_link_libraries TARGET ${target} PROPERTY LINK_FLAGS)
    list(FIND _link_libraries "WebAssemblyInterface" wasm_interface_index)
    if(${wasm_interface_index} GREATER -1)
      set(common_link_flags "${common_link_flags} -s EXPORTED_FUNCTIONS='[\"_main\",\"_itk_wasm_input_array_alloc\",\"_itk_wasm_input_json_alloc\",\"_itk_wasm_output_json_address\",\"_itk_wasm_output_json_size\",\"_itk_wasm_output_array_address\",\"_itk_wasm_output_array_size\",\"_itk_wasm_free_all\"]'")
    else()
      set(common_link_flags "${common_link_flags} -s EXPORTED_FUNCTIONS='[\"_main\"]'")
    endif()

...
function imageIOPixelTypeToJSPixelType(emscriptenModule: ImageIOBaseJSBinding, ioPixelType: typeof IOPixel[keyof typeof IOPixel]): typeof PixelTypes[keyof typeof PixelTypes] | null {
  let pixelType = null
  switch (ioPixelType) {

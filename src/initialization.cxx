...
#  include <stdatomic.h>
  ...
  __attribute__((export_name("itk_wasm_delayed_exit"))) void
  itk_wasm_delayed_exit(int returnCode)
  {
  ...
  __attribute__((export_name("itk_wasm_delayed_start"))) int
  itk_wasm_delayed_start(void)
  {
  ...
  __attribute__((export_name(""))) void
  _start(void)
  {
    //_initialize();
    _initialize_local();

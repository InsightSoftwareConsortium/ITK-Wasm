 ...
 *
 *=========================================================================*/
#ifndef itkSpecializedPipelineFunctor_h
#define itkSpecializedPipelineFunctor_h
...
/** \class SpecializedPipelineFunctor
 *
...
class
SpecializedPipelineFunctor<TPipelineFunctor, VDimension, itk::VariableLengthVector<TComponent>>
{
public:
  int operator()(itk::wasm::Pipeline & pipeline)
  {

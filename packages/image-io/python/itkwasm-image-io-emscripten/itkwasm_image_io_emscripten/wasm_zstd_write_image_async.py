...
async def wasm_zstd_write_image_async(
    image: Image,
    ...
    outputs = await js_module.wasmZstdWriteImage(to_js(image), to_js(serialized_image), webWorker=web_worker, noCopy=True, **kwargs)

...
async def bio_rad_write_image_async(
    image: Image,
    ...
    outputs = await js_module.bioRadWriteImage(to_js(image), to_js(serialized_image), webWorker=web_worker, noCopy=True, **kwargs)

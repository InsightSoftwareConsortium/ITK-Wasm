...
async def wasm_zstd_read_image_async(
    ...
    outputs = await js_module.wasmZstdReadImage(to_js(BinaryFile(serialized_image)), webWorker=web_worker, noCopy=True, **kwargs)

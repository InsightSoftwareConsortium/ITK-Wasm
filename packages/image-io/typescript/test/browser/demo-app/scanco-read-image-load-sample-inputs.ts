...
export default null
// export default async function scancoReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the scancoReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#scancoReadImageInputs [name=example-input]")

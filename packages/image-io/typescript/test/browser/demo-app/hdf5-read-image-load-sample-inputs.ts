...
export default null
// export default async function hdf5ReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the hdf5ReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#hdf5ReadImageInputs [name=example-input]")

...
export default null
// export default async function metaReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the metaReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#metaReadImageInputs [name=example-input]")

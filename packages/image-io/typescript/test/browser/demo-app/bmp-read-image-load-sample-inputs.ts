...
export default null
// export default async function bmpReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the bmpReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#bmpReadImageInputs [name=example-input]")

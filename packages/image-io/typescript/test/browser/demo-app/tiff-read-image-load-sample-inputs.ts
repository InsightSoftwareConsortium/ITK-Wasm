...
export default null
// export default async function tiffReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the tiffReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#tiffReadImageInputs [name=example-input]")

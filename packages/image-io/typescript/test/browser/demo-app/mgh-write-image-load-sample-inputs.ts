...
export default null
// export default async function mghWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the mghWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#mghWriteImageInputs [name=example-input]")

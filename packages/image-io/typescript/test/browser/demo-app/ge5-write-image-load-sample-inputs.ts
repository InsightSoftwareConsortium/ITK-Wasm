...
export default null
// export default async function ge5WriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the ge5WriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#ge5WriteImageInputs [name=example-input]")

...
export default null
// export default async function vtkReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the vtkReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#vtkReadImageInputs [name=example-input]")

...
export default null
// export default async function giplReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the giplReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#giplReadImageInputs [name=example-input]")

...
export default null
// export default async function wasmWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmWriteImageInputs [name=example-input]")

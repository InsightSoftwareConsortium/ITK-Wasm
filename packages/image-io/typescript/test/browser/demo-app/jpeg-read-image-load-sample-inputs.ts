...
export default null
// export default async function jpegReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the jpegReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#jpegReadImageInputs [name=example-input]")

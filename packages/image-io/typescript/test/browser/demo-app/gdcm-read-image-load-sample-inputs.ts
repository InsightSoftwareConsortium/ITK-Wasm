...
export default null
// export default async function gdcmReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the gdcmReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#gdcmReadImageInputs [name=example-input]")

...
export default null
// export default async function fdfWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the fdfWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#fdfWriteImageInputs [name=example-input]")

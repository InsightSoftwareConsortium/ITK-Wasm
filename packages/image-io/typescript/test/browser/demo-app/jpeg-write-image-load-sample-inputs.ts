...
export default null
// export default async function jpegWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the jpegWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#jpegWriteImageInputs [name=example-input]")

...
export default null
// export default async function bmpWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the bmpWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#bmpWriteImageInputs [name=example-input]")

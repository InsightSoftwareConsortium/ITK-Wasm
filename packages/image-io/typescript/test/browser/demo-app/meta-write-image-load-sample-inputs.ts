...
export default null
// export default async function metaWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the metaWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#metaWriteImageInputs [name=example-input]")

...
export default null
// export default async function wasmReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmReadImageInputs [name=example-input]")

...
export default null
// export default async function niftiWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the niftiWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#niftiWriteImageInputs [name=example-input]")

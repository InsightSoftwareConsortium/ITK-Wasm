...
export default null
// export default async function niftiReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the niftiReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#niftiReadImageInputs [name=example-input]")

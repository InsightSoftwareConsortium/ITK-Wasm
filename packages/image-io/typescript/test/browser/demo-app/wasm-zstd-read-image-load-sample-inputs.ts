...
export default null
// export default async function wasmZstdReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmZstdReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmZstdReadImageInputs [name=example-input]")

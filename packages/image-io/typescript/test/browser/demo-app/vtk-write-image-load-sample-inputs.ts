...
export default null
// export default async function vtkWriteImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the vtkWriteImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#vtkWriteImageInputs [name=example-input]")

...
export default null
// export default async function pngReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the pngReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#pngReadImageInputs [name=example-input]")

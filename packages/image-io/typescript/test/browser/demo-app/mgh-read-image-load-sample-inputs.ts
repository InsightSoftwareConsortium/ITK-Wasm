...
export default null
// export default async function mghReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the mghReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#mghReadImageInputs [name=example-input]")

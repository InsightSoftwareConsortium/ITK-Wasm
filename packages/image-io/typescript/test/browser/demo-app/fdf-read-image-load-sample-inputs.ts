...
export default null
// export default async function fdfReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the fdfReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#fdfReadImageInputs [name=example-input]")

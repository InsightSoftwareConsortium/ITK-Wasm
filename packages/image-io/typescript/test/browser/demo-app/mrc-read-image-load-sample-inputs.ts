...
export default null
// export default async function mrcReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the mrcReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#mrcReadImageInputs [name=example-input]")

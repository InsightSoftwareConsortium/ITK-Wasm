...
export default null
// export default async function lsmReadImageLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the lsmReadImage function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#lsmReadImageInputs [name=example-input]")

...
import MetaReadImageNodeOptions from './meta-read-image-node-options.js'
...
async function metaReadImageNode(
  ...
  const pipelinePath = path.join(path.dirname(import.meta.url.substring(7)), 'pipelines', 'meta-read-image')

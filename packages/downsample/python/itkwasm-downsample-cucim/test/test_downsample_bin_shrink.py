...
from itkwasm_downsample_cucim import downsample_bin_shrink
...
def test_downsample_bin_shrink():
    ...
    test_output_file_path = test_output_path / 'downsample-bin-shrink-test-cthead1-cucim.mha'
    ...
    write_image(diff_image, test_output_path / 'downsample-bin-shrink-test-cthead1-cucim-diff.mha')
    write_image(diff_image_uchar, test_output_path / 'downsample-bin-shrink-test-cthead1-cucim-diff-uchar.png')

...
def resample_to_reference(
    ...
    :rtype:  Image
    """
    func = environment_dispatch("itkwasm_downsample", "resample_to_reference")
    output = func(input, reference_image, transform=transform, interpolator=interpolator, default_value=default_value)
    return output

...
export default null
// export default async function resampleBoundingBoxLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the resampleBoundingBox function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#resampleBoundingBoxInputs [name=example-input]")

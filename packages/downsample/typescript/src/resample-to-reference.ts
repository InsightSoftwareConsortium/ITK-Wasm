 ...
 * @param {ResampleToReferenceOptions} options - options object
 *
 * @returns {Promise<ResampleToReferenceResult>} - result object
 */
async function resampleToReference(
  ...
  const pipelinePath = 'resample-to-reference'
...
export default resampleToReference

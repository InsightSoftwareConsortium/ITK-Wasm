...
import matReadTransformLoadSampleInputs, { usePreRun } from "./mat-read-transform-load-sample-inputs.js"

class MatReadTransformModel {
...
class MatReadTransformController {

  constructor(loadSampleInputs) {
    this.loadSampleInputs = loadSampleInputs

    this.model = new MatReadTransformModel()
    const model = this.model

    if (loadSampleInputs) {
      const loadSampleInputsButton = document.querySelector("#matReadTransformInputs [name=loadSampleInputs]")
    ...
    // ----------------------------------------------
    // Inputs
    const serializedTransformElement = document.querySelector('#matReadTransformInputs input[name=serialized-transform-file]')
    serializedTransformElement.addEventListener('change', async (event) => {
        ...
        const details = document.getElementById("matReadTransform-serialized-transform-details")

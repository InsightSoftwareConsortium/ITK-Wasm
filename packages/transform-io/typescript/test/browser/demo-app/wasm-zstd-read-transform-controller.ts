...
class WasmZstdReadTransformController {

  constructor(loadSampleInputs) {
    this.loadSampleInputs = loadSampleInputs

    this.model = new WasmZstdReadTransformModel()
    const model = this.model

    if (loadSampleInputs) {
      const loadSampleInputsButton = document.querySelector("#wasmZstdReadTransformInputs [name=loadSampleInputs]")
    ...
    // ----------------------------------------------
    // Inputs
    const serializedTransformElement = document.querySelector('#wasmZstdReadTransformInputs input[name=serialized-transform-file]')
    serializedTransformElement.addEventListener('change', async (event) => {
        ...
        const details = document.getElementById("wasmZstdReadTransform-serialized-transform-details")

 ...
 * @param {WasmWriteTransformOptions} options - options object
 *
 * @returns {Promise<WasmWriteTransformResult>} - result object
 */
async function wasmWriteTransform(
  ...
  const pipelinePath = 'wasm-write-transform'
...
export default wasmWriteTransform

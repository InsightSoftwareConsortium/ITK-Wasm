 ...
 * @param {MncWriteTransformOptions} options - options object
 *
 * @returns {Promise<MncWriteTransformResult>} - result object
 */
async function mncWriteTransform(
  ...
  const pipelinePath = 'mnc-write-transform'
...
export default mncWriteTransform

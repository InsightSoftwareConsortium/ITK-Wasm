 ...
 * @param {TxtReadTransformOptions} options - options object
 *
 * @returns {Promise<TxtReadTransformResult>} - result object
 */
async function txtReadTransform(
  ...
  const pipelinePath = 'txt-read-transform'
...
export default txtReadTransform

 ...
 * @param {MatReadTransformOptions} options - options object
 *
 * @returns {Promise<MatReadTransformResult>} - result object
 */
async function matReadTransform(
  ...
  const pipelinePath = 'mat-read-transform'
...
export default matReadTransform

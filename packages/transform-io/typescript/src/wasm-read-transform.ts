 ...
 * @param {WasmReadTransformOptions} options - options object
 *
 * @returns {Promise<WasmReadTransformResult>} - result object
 */
async function wasmReadTransform(
  ...
  const pipelinePath = 'wasm-read-transform'
...
export default wasmReadTransform

 ...
 * @param {MatWriteTransformOptions} options - options object
 *
 * @returns {Promise<MatWriteTransformResult>} - result object
 */
async function matWriteTransform(
  ...
  const pipelinePath = 'mat-write-transform'
...
export default matWriteTransform

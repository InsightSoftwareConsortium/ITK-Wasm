 ...
 * @param {MncReadTransformOptions} options - options object
 *
 * @returns {Promise<MncReadTransformResult>} - result object
 */
async function mncReadTransform(
  ...
  const pipelinePath = 'mnc-read-transform'
...
export default mncReadTransform

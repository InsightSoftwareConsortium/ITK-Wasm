...
def wasm_zstd_write_transform(
    ...
    if _pipeline is None:
        _pipeline = Pipeline(file_resources('itkwasm_transform_io_wasi').joinpath(Path('wasm_modules') / Path('wasm-zstd-write-transform.wasi.wasm')))

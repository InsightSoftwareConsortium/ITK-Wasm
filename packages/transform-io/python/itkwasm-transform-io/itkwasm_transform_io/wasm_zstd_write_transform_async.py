...
async def wasm_zstd_write_transform_async(
    ...
    :rtype:  Any
    """
    func = environment_dispatch("itkwasm_transform_io", "wasm_zstd_write_transform_async")
    output = await func(transform, serialized_transform, float_parameters=float_parameters, use_compression=use_compression)
    return output

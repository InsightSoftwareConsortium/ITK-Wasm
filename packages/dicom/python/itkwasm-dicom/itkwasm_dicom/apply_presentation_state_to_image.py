...
def apply_presentation_state_to_image(
    ...
    output = func(image_in, presentation_state_file, config_file=config_file, frame=frame, presentation_state_output=presentation_state_output, bitmap_output=bitmap_output, pgm=pgm, dicom=dicom)
    return output

export default async function structuredReportToTextLoadSampleInputs(model) {
  ...
  const dicomElement = document.querySelector('#structuredReportToTextInputs  sl-input[name=dicom-file]')

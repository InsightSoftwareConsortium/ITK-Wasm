...
int main (int argc, char * argv[])
{
  ...
  file_type = plm_file_format_deduce(referenceDicomSeries.c_str());
  std::cout << "file_type: " << plm_file_format_string(file_type) << std::endl;

  rt_study.load(referenceDicomSeries, file_type);

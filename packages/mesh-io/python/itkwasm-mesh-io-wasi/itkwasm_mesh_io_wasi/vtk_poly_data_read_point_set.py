...
def vtk_poly_data_read_point_set(
    ...
    if _pipeline is None:
        _pipeline = Pipeline(file_resources('itkwasm_mesh_io_wasi').joinpath(Path('wasm_modules') / Path('vtk-poly-data-read-point-set.wasi.wasm')))

...
def wasm_zstd_write_point_set(
    ...
    if _pipeline is None:
        _pipeline = Pipeline(file_resources('itkwasm_mesh_io_wasi').joinpath(Path('wasm_modules') / Path('wasm-zstd-write-point-set.wasi.wasm')))

...
def free_surfer_binary_read_mesh(
    ...
    if _pipeline is None:
        _pipeline = Pipeline(file_resources('itkwasm_mesh_io_wasi').joinpath(Path('wasm_modules') / Path('free-surfer-binary-read-mesh.wasi.wasm')))

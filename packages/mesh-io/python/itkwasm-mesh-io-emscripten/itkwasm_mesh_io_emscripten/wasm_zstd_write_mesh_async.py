...
async def wasm_zstd_write_mesh_async(
    mesh: Mesh,
    serialized_mesh: str,
    ...
    outputs = await js_module.wasmZstdWriteMesh(to_js(mesh), to_js(serialized_mesh), webWorker=web_worker, noCopy=True, **kwargs)

...
async def obj_read_point_set_async(
    ...
    outputs = await js_module.objReadPointSet(to_js(BinaryFile(serialized_point_set)), webWorker=web_worker, noCopy=True, **kwargs)

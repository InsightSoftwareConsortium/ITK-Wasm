...
async def off_write_point_set_async(
    point_set: PointSet,
    ...
    outputs = await js_module.offWritePointSet(to_js(point_set), to_js(serialized_point_set), webWorker=web_worker, noCopy=True, **kwargs)

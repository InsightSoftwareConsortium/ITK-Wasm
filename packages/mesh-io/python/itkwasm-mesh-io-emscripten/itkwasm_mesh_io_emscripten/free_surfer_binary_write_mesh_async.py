...
async def free_surfer_binary_write_mesh_async(
    mesh: Mesh,
    serialized_mesh: str,
    ...
    outputs = await js_module.freeSurferBinaryWriteMesh(to_js(mesh), to_js(serialized_mesh), webWorker=web_worker, noCopy=True, **kwargs)

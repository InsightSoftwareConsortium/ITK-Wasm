...
async def wasm_zstd_read_point_set_async(
    ...
    outputs = await js_module.wasmZstdReadPointSet(to_js(BinaryFile(serialized_point_set)), webWorker=web_worker, noCopy=True, **kwargs)

...
async def vtk_poly_data_read_mesh_async(
    ...
    outputs = await js_module.vtkPolyDataReadMesh(to_js(BinaryFile(serialized_mesh)), webWorker=web_worker, noCopy=True, **kwargs)

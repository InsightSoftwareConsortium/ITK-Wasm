...
export default null
// export default async function wasmReadPointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmReadPointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmReadPointSetInputs [name=example-input]")

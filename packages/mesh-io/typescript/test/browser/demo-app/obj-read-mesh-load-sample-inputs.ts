...
export default null
// export default async function objReadMeshLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the objReadMesh function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#objReadMeshInputs [name=example-input]")

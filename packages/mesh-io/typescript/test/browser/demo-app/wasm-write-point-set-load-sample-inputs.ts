...
export default null
// export default async function wasmWritePointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmWritePointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmWritePointSetInputs [name=example-input]")

...
export default null
// export default async function objWriteMeshLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the objWriteMesh function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#objWriteMeshInputs [name=example-input]")

...
export default null
// export default async function swcReadMeshLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the swcReadMesh function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#swcReadMeshInputs [name=example-input]")

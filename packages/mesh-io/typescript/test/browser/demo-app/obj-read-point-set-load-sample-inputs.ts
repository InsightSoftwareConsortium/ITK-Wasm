...
export default null
// export default async function objReadPointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the objReadPointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#objReadPointSetInputs [name=example-input]")

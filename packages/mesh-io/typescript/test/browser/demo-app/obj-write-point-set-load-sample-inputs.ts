...
export default null
// export default async function objWritePointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the objWritePointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#objWritePointSetInputs [name=example-input]")

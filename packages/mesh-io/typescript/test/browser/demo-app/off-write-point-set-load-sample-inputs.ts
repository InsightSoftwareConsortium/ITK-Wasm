...
export default null
// export default async function offWritePointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the offWritePointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#offWritePointSetInputs [name=example-input]")

...
export default null
// export default async function offReadPointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the offReadPointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#offReadPointSetInputs [name=example-input]")

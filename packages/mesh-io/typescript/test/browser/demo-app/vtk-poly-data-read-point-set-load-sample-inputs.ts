...
export default null
// export default async function vtkPolyDataReadPointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the vtkPolyDataReadPointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#vtkPolyDataReadPointSetInputs [name=example-input]")

...
export default null
// export default async function wasmZstdWritePointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmZstdWritePointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmZstdWritePointSetInputs [name=example-input]")

...
export default null
// export default async function stlReadMeshLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the stlReadMesh function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#stlReadMeshInputs [name=example-input]")

...
export default null
// export default async function vtkPolyDataWritePointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the vtkPolyDataWritePointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#vtkPolyDataWritePointSetInputs [name=example-input]")

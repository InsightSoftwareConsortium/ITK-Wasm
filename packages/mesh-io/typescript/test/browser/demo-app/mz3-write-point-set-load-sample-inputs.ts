...
export default null
// export default async function mz3WritePointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the mz3WritePointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#mz3WritePointSetInputs [name=example-input]")

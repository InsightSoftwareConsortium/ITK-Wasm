...
export default null
// export default async function wasmZstdReadPointSetLoadSampleInputs (model, preRun=false) {

  // Load sample inputs for the wasmZstdReadPointSet function.
  //
  ...
  // if (!preRun) {
  //   const exampleElement = document.querySelector("#wasmZstdReadPointSetInputs [name=example-input]")

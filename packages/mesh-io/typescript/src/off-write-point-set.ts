 ...
 * @param {OffWritePointSetOptions} options - options object
 *
 * @returns {Promise<OffWritePointSetResult>} - result object
 */
async function offWritePointSet(
  pointSet: PointSet,
  serializedPointSet: string,
  options: OffWritePointSetOptions = {}
) : Promise<OffWritePointSetResult> {
  ...
  const pipelinePath = 'off-write-point-set'
...
export default offWritePointSet

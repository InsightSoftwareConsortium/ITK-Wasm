...
async function freeSurferAsciiReadMeshNode(
  ...
  const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'free-surfer-ascii-read-mesh')
...
export default freeSurferAsciiReadMeshNode

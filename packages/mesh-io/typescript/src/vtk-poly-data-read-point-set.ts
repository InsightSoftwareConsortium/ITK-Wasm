 ...
 * @param {VtkPolyDataReadPointSetOptions} options - options object
 *
 * @returns {Promise<VtkPolyDataReadPointSetResult>} - result object
 */
async function vtkPolyDataReadPointSet(
  serializedPointSet: File | BinaryFile,
  options: VtkPolyDataReadPointSetOptions = {}
) : Promise<VtkPolyDataReadPointSetResult> {
  ...
  const pipelinePath = 'vtk-poly-data-read-point-set'
...
export default vtkPolyDataReadPointSet

 ...
 * @param {Mz3ReadPointSetOptions} options - options object
 *
 * @returns {Promise<Mz3ReadPointSetResult>} - result object
 */
async function mz3ReadPointSet(
  serializedPointSet: File | BinaryFile,
  options: Mz3ReadPointSetOptions = {}
) : Promise<Mz3ReadPointSetResult> {
  ...
  const pipelinePath = 'mz3-read-point-set'
...
export default mz3ReadPointSet

 ...
 * @param {ObjWritePointSetOptions} options - options object
 *
 * @returns {Promise<ObjWritePointSetResult>} - result object
 */
async function objWritePointSet(
  pointSet: PointSet,
  serializedPointSet: string,
  options: ObjWritePointSetOptions = {}
) : Promise<ObjWritePointSetResult> {
  ...
  const pipelinePath = 'obj-write-point-set'
...
export default objWritePointSet

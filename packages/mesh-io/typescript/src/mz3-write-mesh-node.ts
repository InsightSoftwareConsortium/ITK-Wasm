...
import Mz3WriteMeshNodeOptions from './mz3-write-mesh-node-options.js'
 ...
 * @param {Mz3WriteMeshNodeOptions} options - options object
 *
 * @returns {Promise<Mz3WriteMeshNodeResult>} - result object
 */
async function mz3WriteMeshNode(
  ...
  const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'mz3-write-mesh')
...
export default mz3WriteMeshNode

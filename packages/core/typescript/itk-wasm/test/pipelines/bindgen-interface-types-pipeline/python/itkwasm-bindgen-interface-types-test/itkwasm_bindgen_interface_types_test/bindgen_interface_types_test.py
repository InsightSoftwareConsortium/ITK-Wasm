...
def bindgen_interface_types_test(
    ...
    :rtype:  Mesh
    """
    func = environment_dispatch("itkwasm_bindgen_interface_types_test", "bindgen_interface_types_test")
    output = func(input_text_file, input_binary_file, input_text_stream, input_binary_stream, input_json, input_image, input_mesh, output_text_file, output_binary_file, integer_type=integer_type, floating_type=floating_type, floating_range=floating_range, floating_vector=floating_vector, floating_type_size=floating_type_size, floating_type_size_range=floating_type_size_range)
    return output

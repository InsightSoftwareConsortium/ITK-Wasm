...
import CreateCompositeTransformOptions from './create-composite-transform-options.js'
import CreateCompositeTransformResult from './create-composite-transform-result.js'
 ...
 *
 * @param {CreateCompositeTransformOptions} options - options object
 *
 * @returns {Promise<CreateCompositeTransformResult>} - result object
 */
async function createCompositeTransform(
  ...
  const pipelinePath = 'create-composite-transform'
...
export default createCompositeTransform

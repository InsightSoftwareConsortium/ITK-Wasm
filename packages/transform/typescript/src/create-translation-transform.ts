...
import CreateTranslationTransformOptions from './create-translation-transform-options.js'
import CreateTranslationTransformResult from './create-translation-transform-result.js'
 ...
 *
 * @param {CreateTranslationTransformOptions} options - options object
 *
 * @returns {Promise<CreateTranslationTransformResult>} - result object
 */
async function createTranslationTransform(
  ...
  const pipelinePath = 'create-translation-transform'
...
export default createTranslationTransform

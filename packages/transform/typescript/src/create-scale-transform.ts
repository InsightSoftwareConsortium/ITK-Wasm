...
import CreateScaleTransformOptions from './create-scale-transform-options.js'
import CreateScaleTransformResult from './create-scale-transform-result.js'
 ...
 *
 * @param {CreateScaleTransformOptions} options - options object
 *
 * @returns {Promise<CreateScaleTransformResult>} - result object
 */
async function createScaleTransform(
  ...
  const pipelinePath = 'create-scale-transform'
...
export default createScaleTransform

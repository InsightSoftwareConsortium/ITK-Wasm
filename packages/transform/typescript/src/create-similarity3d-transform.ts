...
import CreateSimilarity3dTransformOptions from './create-similarity3d-transform-options.js'
import CreateSimilarity3dTransformResult from './create-similarity3d-transform-result.js'
 ...
 *
 * @param {CreateSimilarity3dTransformOptions} options - options object
 *
 * @returns {Promise<CreateSimilarity3dTransformResult>} - result object
 */
async function createSimilarity3dTransform(
  ...
  const pipelinePath = 'create-similarity3d-transform'
...
export default createSimilarity3dTransform

...
import CreateRigid3dTransformOptions from './create-rigid3d-transform-options.js'
import CreateRigid3dTransformResult from './create-rigid3d-transform-result.js'
 ...
 *
 * @param {CreateRigid3dTransformOptions} options - options object
 *
 * @returns {Promise<CreateRigid3dTransformResult>} - result object
 */
async function createRigid3dTransform(
  ...
  const pipelinePath = 'create-rigid3d-transform'
...
export default createRigid3dTransform

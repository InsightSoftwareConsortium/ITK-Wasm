...
import CreateIdentityTransformOptions from './create-identity-transform-options.js'
import CreateIdentityTransformResult from './create-identity-transform-result.js'
 ...
 *
 * @param {CreateIdentityTransformOptions} options - options object
 *
 * @returns {Promise<CreateIdentityTransformResult>} - result object
 */
async function createIdentityTransform(
  ...
  const pipelinePath = 'create-identity-transform'
...
export default createIdentityTransform

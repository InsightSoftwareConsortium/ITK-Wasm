...
import CreateBsplineTransformOptions from './create-bspline-transform-options.js'
import CreateBsplineTransformResult from './create-bspline-transform-result.js'
 ...
 *
 * @param {CreateBsplineTransformOptions} options - options object
 *
 * @returns {Promise<CreateBsplineTransformResult>} - result object
 */
async function createBsplineTransform(
  ...
  const pipelinePath = 'create-bspline-transform'
...
export default createBsplineTransform
